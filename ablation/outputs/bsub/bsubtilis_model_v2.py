...
learn.fit_one_cycle(EPOCHS,max_lr=0.0001,callbacks=[callbacks.SaveModelCallback(learn,every='improvement',monitor='accuracy',name='original_bsubtilis_model')])
...
data = ImageDataBunch.from_folder(PATH,ds_tfms=tfms, bs=32)
learn = cnn_learner(data, models.resnet18, metrics=accuracy)
learn.fit_one_cycle(EPOCHS,max_lr=0.0001,callbacks=[callbacks.SaveModelCallback(learn,every='improvement',monitor='accuracy',name='no_hflip_bsubtilis_model')])
...
data = ImageDataBunch.from_folder(PATH,ds_tfms=tfms, bs=32)
learn = cnn_learner(data, models.resnet18, metrics=accuracy)
learn.fit_one_cycle(EPOCHS,max_lr=0.0001,callbacks=[callbacks.SaveModelCallback(learn,every='improvement',monitor='accuracy',name='no_zoom_bsubtilis_model')])
...
data = ImageDataBunch.from_folder(PATH,ds_tfms=tfms, bs=32)
learn = cnn_learner(data, models.resnet18, metrics=accuracy)
learn.fit_one_cycle(EPOCHS,max_lr=0.0001,callbacks=[callbacks.SaveModelCallback(learn,every='improvement',monitor='accuracy',name='no_zoom_no_hflip_bsubtilis_model')])
